describe("Given propertyFormatter", function() {
  ...
  describe("when calling extractDataPropertiesForDisplay(object)", function() {
    var propertiesForDisplay;
    ...
    beforeEach(function() {
      ...
      propertiesForDisplay = propertyFormatter.extractDataPropertiesForDisplay(source);
    });
  ...
  describe("when calling extractDataPropertiesForDisplayForAnyObject(object)", function() {
    var propertiesForDisplay;
    ...
    beforeEach(function() {
      ...
      propertiesForDisplay = propertyFormatter.extractDataPropertiesForDisplayForAnyObject(source);
    });

    it("then the returned property count should be correct", function() {
      expect(propertiesForDisplay.length).toEqual(6);
    });

    it("then the 'price' property should be displayed", function() {
      expect(propertiesForDisplay[3]).toMatch("price.+10");
    });

    it("then the 'description' property should not be displayed", function() {
      expect(propertiesForDisplay[1]).toMatch("cannot be displayed");
    });
  });
